// TestCaseFirstLastLinkList Class
public class TestCaseFirstLastLinkList<T, L extends FirstLastLinkList> {
    ...
    public static void runTests(TestCaseFirstLastLinkList[] cases) {
        boolean pass = true;
