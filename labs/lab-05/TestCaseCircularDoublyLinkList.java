// CircularDoublyLinkList Class
public class TestCaseCircularDoublyLinkList<T, L extends CircularDoublyLinkList> {
    ...
    public static void runTests(TestCaseCircularDoublyLinkList[] cases) {
        boolean pass = true;
