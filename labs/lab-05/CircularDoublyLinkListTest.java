public class CircularDoublyLinkListTest {
    ...
    public static void testUpdateIndex() {
        ...
        TestCaseCircularDoublyLinkList[] cases = new TestCaseCircularDoublyLinkList[3];

        // normal case
        cases[0] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[0].list = new CircularDoublyLinkList<Integer>(3, 5, 7);
        cases[0].list.updateAt(1, 2);
        cases[0].setExpected("[ 3 2 7]");
        cases[0].setActual(cases[0].list.toString());

        // case insert at head
        cases[1] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[1].list = new CircularDoublyLinkList<Integer>(10, 57);
        cases[1].list.updateAt(0, 5);
        cases[1].setExpected("[ 5 57]");
        cases[1].setActual(cases[1].list.toString());

        // case insert at before tail
        cases[2] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[2].list = new CircularDoublyLinkList<Integer>(10, 57);
        cases[2].list.updateAt(1, 2);
        cases[2].setExpected("[ 10 2]");
        cases[2].setActual(cases[2].list.toString());

        TestCaseCircularDoublyLinkList.runTests(cases);
    }
    ...
    public static void testRetrieveIndex() {
        ...
        // normal case
        cases[0] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[0].list = new CircularDoublyLinkList<String>("A", "B", "C");
    ...
    public static void testRemoveIndex() {
        ...
        TestCaseCircularDoublyLinkList[] cases = new TestCaseCircularDoublyLinkList[4];
        ...
        cases[3] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[3].list = new CircularDoublyLinkList<Integer>(10);
    ...
    public static void testDeleteLast() {
        ...
        cases[1] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[1].list = new CircularDoublyLinkList<Integer>(10);
        cases[1].list.deleteLast();
        cases[1].setExpected("[]");
        cases[1].setActual(cases[1].list.toString());

        cases[2] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[2].list = new CircularDoublyLinkList<Integer>();
    ...
    public static void testDelete() {
        ...
        TestCaseCircularDoublyLinkList[] cases = new TestCaseCircularDoublyLinkList[6];
        ...
        cases[3] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[3].list = new CircularDoublyLinkList<Integer>(10, 12, 16);
        cases[3].list.delete(57);
        cases[3].setExpected("[ 10 12 16]");
        cases[3].setActual(cases[3].list.toString());

        // case delete the only element in the list
        cases[4] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[4].list = new CircularDoublyLinkList<Integer>(10);
        cases[4].list.delete(10);
        cases[4].setExpected("[]");
        cases[4].setActual(cases[4].list.toString());

        // case delete from empty list
        cases[5] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[5].list = new CircularDoublyLinkList<Integer>();
    ...
    public static void testInsertLast() {
        ...
        TestCaseCircularDoublyLinkList[] cases = new TestCaseCircularDoublyLinkList[2];
        ...
        cases[1] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[1].list = new CircularDoublyLinkList<Integer>();
    ...
    public static void testSetFirst() {
        ...
        cases[1] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[1].list = new CircularDoublyLinkList<Integer>(3, 5, 7);
        CNode<Integer> newCNode = new CNode(10);
        String oldElm2 = cases[1].list.setFirst(newCNode).toString();
    ...
    public static void testConstructer() {
        ...
        cases[0] = new TestCaseCircularDoublyLinkList<String, CircularDoublyLinkList<Integer>>();
        cases[0].list = new CircularDoublyLinkList<Integer>(3, 5, 7, 3);
