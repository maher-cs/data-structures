...
public class HighArrayTest {
    ...
    public static void testRemoveDuplicates() {
        ...
        cases[0] = new TestCase<String>();
        cases[0].hArray = new HighArray<Integer>(3, 5, 7, 7, 3, 5);
    ...
    public static void testRemove() {
        ...
        cases[0] = new TestCase<String>();
        cases[0].hArray = new HighArray<Integer>(3, 5, 7, 10);
    ...
    public static void testFindAll() {
        HighArray<Integer> hArray;
        int[] expected, actual;
        boolean pass = true;
        System.out.print("testing findAll method...");

        // case1
        hArray = new HighArray<Integer>(3, 5, 7, 7, 10);
        ...
        // case2
        hArray = new HighArray<Integer>(7, 7, 7, 7, 7);
        ...
        // case3
        hArray = new HighArray<Integer>(3, 5, 5, 5, 10);
    ...
    public static void testInsertAt() {
        ...
        cases[2].hArray = new HighArray<Integer>(3, 5, 7, 10);
    ...
    public static void testSize() {
        ...
        cases[0] = new TestCase<Integer>();
        cases[0].hArray = new HighArray<String>("m", "t", "g");
        cases[0].setExpected(3);
    ...
    private static void testConstructorList() {
        ...
        cases[0] = new TestCase<String>();
        cases[0].hArray = new HighArray<Integer>(5, 3, 6);
        cases[0].setExpected("[ 5 3 6]");
        cases[0].setActual(cases[0].hArray.toString());

        cases[1] = new TestCase<String>();
        cases[1].hArray = new HighArray<String>("m", "t", "g");
    ...
    private static void testInsertList() {
        ...
        cases[0] = new TestCase<String>();
        cases[0].hArray = new HighArray<Integer>(3);
     ...
     private static void testInsert() {
        ...
        cases[1] = new TestCase<String>();
        cases[1].hArray = new HighArray<Integer>(2);
    ...
    private static void testConstructorSize() {
        ...
        cases[0] = new TestCase<String>();
        cases[0].hArray = new HighArray<Integer>(5);
        cases[0].setExpected("[]");
        cases[0].setActual(cases[0].hArray.toString());

        cases[1] = new TestCase<String>();
        cases[1].hArray = new HighArray<String>(5);
        cases[1].setExpected("[]");
